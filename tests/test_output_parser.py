...
def test_parse_output_one_cmpnt():
    ...
    general = {
        ...
        'box_alpha_units': 'degrees',
        'box_alpha_dev': 0.0,
        'box_beta_average': 52.8626,
        'box_beta_units': 'degrees',
        'box_beta_dev': 0.0,
        'box_gamma_average': 90.0,
        'box_gamma_units': 'degrees',
        'box_gamma_dev': 0.0,
...
def test_parse_output_two_cmpnt():
    ...
    general = {
        ...
        'enthalpy_of_adsorption_total_molfrac_units': 'K',
